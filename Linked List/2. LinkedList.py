# Linked list implementation using a 2D array
...
def display():
    ...
    while CurrentPointer != -1:
        ...
        print(f"Index : {CurrentPointer} | Data : {LinkedList[CurrentPointer][0]} | Pointer : {LinkedList[CurrentPointer][1]}")
...
def insert():
    ...
    if FreePointer == 0:
        LinkedList.append([data, -1])  # Append node to the end of the list
    else:
        CurrentPointer = StartPointer
        while CurrentPointer != -1:
            ...
            CurrentPointer = LinkedList[CurrentPointer][1]
        LinkedList.append([data, -1])  # Append node to the end of the list
        LinkedList[prevPointer][1] = FreePointer  # Update pointer of the previous node
...
def insertAt():
    ...
    if index == 0:
        ...
        LinkedList.append([data, StartPointer])
    ...
    LinkedList[prevPointer][1] = EntryPointer
    LinkedList[EntryPointer][1] = CurrentPointer
    FreePointer += 1
...
def remove():
    ...
    if len(LinkedList) == 0:
        ...
        if prevPointer == -1:  # If the data is in the first node
            StartPointer = LinkedList[CurrentPointer][1]
        else:
            LinkedList[prevPointer][1] = LinkedList[CurrentPointer][1]
